...
-- TODO: when this runs for the first time
-- it fails as the group is not created. This causes
-- the GetCoordinator call to fail.
-- Do a produce, consume without any assertions first
-- then start the test
...
for i = 1, 1 do
  describe("Test conntinuous polling; run #" .. i, function()
    ...
    it("subscribe and keep polling while producing new messages", function()
